...
![The table that is used to test the policies.](/images/blog/2024-07-01-supabase-realtime-broadcast-and-presence-authorization/schema--dark.png)

The table that is used to test the policies.

![The table that is used to test the policies.](/images/blog/2024-07-01-supabase-realtime-broadcast-and-presence-authorization/schema--light.png)
...
![one-user-connection--dark.png](/images/blog/2024-07-01-supabase-realtime-broadcast-and-presence-authorization/one-user-connection--dark.png)

![one-user-connection--light.png](/images/blog/2024-07-01-supabase-realtime-broadcast-and-presence-authorization/one-user-connection--light.png)
