...
- [Create RLS policies](https://www.notion.so/Blog-Post-for-Realtime-Authz-4600e5a2a3d34ecab5c9e1bbdf53524d?pvs=21)
- [Enable authorization on connect](https://www.notion.so/Blog-Post-for-Realtime-Authz-4600e5a2a3d34ecab5c9e1bbdf53524d?pvs=21)
...
Since we're doing this as soon as the user subscribes to Channel we should see a small increase in subscriptions but after that we do not run any queries on the database and we use the stored context to control the actions a user can perform.
